    ...
    <div class="navbar-brand fw-bold">회차관리</div>
      <ul class="navbar-nav me-auto">
        <li class="nav-item me-2">
          <a class="nav-link text-dark" href="/storyRoom/chapter/list?book_idx=${book.book_idx}">회차목록</a>
        </li>
        <li class="nav-item me-2">
            ...
            <div class="list-group-item list-group-item-action d-flex justify-content-between">
                    	<div class="position-relative">
                    		<div>
                    			...
                    			<a class="stretched-link" href="/storyRoom/chapter/list?book_idx=${chapter.book_idx}&chapter_idx=${chapter.chapter_idx}">
                    			<c:if test="${chapter.chapter_isHidden eq 'Y'}">
                    		...
                    		<div>
                    			<small><fmt:parseDate value="${chapter.chapter_regDate}" var="parsedChapterDateTime" pattern="yyyy-MM-dd'T'HH:mm" type="both"/>
								<fmt:formatDate value="${parsedChapterDateTime}" pattern="yy. MM. dd."/></small>
                    		</div>
                    	</div>
                    	<div class="dropdown">
